...
public class SearchConfig {
    ...
    public String getTxtpathConfig(){
        String txtPath= props.getProperty("txtPath");
        return txtPath;
    }

    public String getTxtnameConfig(){
        String txtname= props.getProperty("txtname");
        return txtname;
    }


    public String getTabooTxtnameConfig(){
        String txtname= props.getProperty("tabootxtname");
        return txtname;
    }
}
