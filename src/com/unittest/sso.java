...
public class sso {
    public AccessTokenVo getAccessToken(String grantCode) {
        ...
        UiaClient uiaClient = new DefaultUiaClient("https://bjt.beijing.gov.cn/renzheng/");
        ...
        try {                                                                                    //获取 access_token
            UiaOauthAccessTokenRequest request = new UiaOauthAccessTokenRequest("/api/oauth/getAccessToken",         //接口路径
                        //    "100100000131",                                            //测试应用client_id
                            "100100000197",                                         //正式应用client_id
                         //   "27a2cdc6f8a6304087aa8a6d00de8cd6",                  //测试应用秘钥client_secret
                               "7caf52dfb979301591210f51a4a4033f",                  //正式应用秘钥client_secret
