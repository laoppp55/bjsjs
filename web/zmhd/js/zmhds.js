function doLoginLetter() {
    $.post("/_prog/getUserinfo.jsp",{
        },
        function(data) {
           if(data.userName=="" || typeof(data.userName) == "undefined"){
               alert("未登录");
               window.location.href = "https://bjt.beijing.gov.cn/renzheng/open/login/goUserLogin?client_id=100100000197&redirect_uri=http://www.bjsjs.gov.cn/_prog/callback.jsp&response_type=code&scope=user_info&state=1";
           }else {
...
function logoff() {
    ...
    window.location.href="/zmhd/wyxx/";
}
